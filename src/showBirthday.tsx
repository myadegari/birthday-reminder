...
export default function ShowBirthday() {
  ...
  return (
  <>
    <div className='flex items-center justify-center w-[100%] mb-5 sm:mb-0 sm:ml-5'>
    ...
    <div className='flex flex-col divide-y-2 border-dashed px-5 pt-5 border-blue-200 border-t-2 sm:border-r-2 sm:pr-5 sm:border-t-0 sm:pt-2 sm:px-0 sm:w-full '>
      {persons.length ? calculateBirthdays(persons).sort((a,b)=>{
          if(a.daysToBirthday && b.daysToBirthday){
            ...
            <div key={person.id} className='flex items-center gap-2 p-2 justify-between w-full'>
