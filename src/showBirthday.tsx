...
export default function ShowBirthday() {
  ...
  return (
  <>
    <div className='flex items-center justify-center w-[100%] mb-5 md:mb-0 md:ml-5'>
    ...
    <div className='flex flex-col divide-y-2 border-dashed px-5 pt-5 border-blue-200 border-t-2 md:border-r-2 md:pr-5 md:border-t-0 md:pt-2 md:px-0 md:w-full w-10/12'>
